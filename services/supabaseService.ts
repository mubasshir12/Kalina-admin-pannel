...
const AGENT_SUPABASE_URL = 'https://txlogzxtdltxcmkhcqsi.supabase.co';
const AGENT_SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR4bG9nenh0ZGx0eGNta2hjcXNpIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDg3NTgzMywiZXhwIjoyMDc2NDUxODMzfQ.OSQB7x3RgM6OKTjSckoSgL6r8vpOq3vnlNzfj-tDgLs';
...
const MAIN_SUPABASE_URL = 'https://rrpwqxhwwcgcagzkfoip.supabase.co';
const MAIN_SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJycHdxeGh3d2NnY2Fnemtmb2lwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDIzNDE3NiwiZXhwIjoyMDc1ODEwMTc2fQ.RDHlMAYngd7I_UAzjdr7p0QDy9SgJrga5m_qOZYoGU4';
